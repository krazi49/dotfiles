...
# Options
option_1="Take one now"
option_2="Take one at a set time"

option_capture_1="Take a screenshot of the whole display"
option_capture_2="Only take a screenshot of the active display"
option_capture_3="Take a screenshot in a selected area"

option_time_1="Take one in 5 seconds"
option_time_2="Take one in 10 seconds"
option_time_3="Take one in 20 seconds"
option_time_4="Take one in 30 seconds"
option_time_5="Take one in a minute"
option_time_6="Or, give us a custom time (in seconds)" # Roadmap or someone contribute :)

list_col='1'
list_row='2'

copy='Copy the screenshot'
save='Save the screenshot'
copy_save='Copy and save the screenshot'
edit='Or, edit it'
